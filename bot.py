...
from commands.auth import auth_start, auth_link, auth_forget, auth_process, auth_stats, auth_list
...
app.add_handler(MessageHandler(auth_stats, filters.private & ~filters.me & filters.command('stats')))
app.add_handler(MessageHandler(auth_list, filters.private & ~filters.me & filters.command('list')))
